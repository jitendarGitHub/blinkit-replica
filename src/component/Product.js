        ...
        <>
            ...
            <div className="group hover:scale-10 ease-in flex flex-col border-2 border-green-10 gap-3  h-[320px]  mt-2 ml-5  rounded-xl  items-center">
                ...
                <div className="d-flex justify-content-between ">
                    ...
                    <div className=" text-end justify-between mx-3 "> {cart.some((p) => p.id === item.id) ? (
                        <div className="btns">
                            <button className='btn btn-success' onClick={() => { dispatch(adds(1)) }}><span className="mb-2">+</span></button><span className="mx-2">{cart.length}</span>
                            <button className='btn btn-success  ' onClick={() => { dispatch(removes(-1)) }}><span>-</span></button>
                        </div>
